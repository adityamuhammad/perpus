...
import { modalBooksClose, saveBooksRequest } from '../../redux/books/booksAction';

function ModalForm({closeModal, saveBook}){
        ...
        <div className="relative w-auto my-8 mx-auto max-w-3xl">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="flex items-start justify-between p-3 border-b border-solid border-gray-300 rounded-t">
              <h3 className="text-1xl font-semibold">Buku</h3>
                  ...
                  <div className="shadow px-6 py-4 overflow-hidden sm:rounded-md">
                    <div className="px-8 py-8 bg-white sm:p-6">
                      <div className="grid grid-cols-6 gap-6">
                        ...
                        <div className="col-span-10">
                          <label htmlFor="published_date" className="block text-sm font-medium text-gray-700">Tanggal publish</label>
                          <input type="date" ref={register({ required: true})} name="published_date" className={
                            `mt-1 block w-full shadow-sm sm:text-sm ${errors.published_date ? "focus:ring-red-500 focus:border-red-500 rounded-md border-red-300" 
                            : "focus:ring-indigo-500 focus:border-indigo-500 rounded-md border-gray-300"}`}/>
                          {errors.published_date ? (<p className="text-xs text-red-500">Tanggal Publish wajib diisi</p>) : null}
                        </div>
                      </div>
                    </div>
                  </div>

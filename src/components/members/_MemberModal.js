          ...
          <div 
            ...
            <div 
              ...
              <h3 className="text-1xl font-semibold"> 
                { modalType === 'new' ? 'Tambah Buku' : 'Edit Buku' }
              </h3>
                    ...
                    <div className="px-8 py-8 bg-white sm:p-6">
                      <div className="grid grid-cols-6 gap-6">
                        ...
                        <div className="col-span-10">
                          ...
                          {errors.name && (<p className="text-xs text-red-500">Nama wajib diisi.</p>)}
                        </div>
                        ...
                        <div className="col-span-10">
                          ...
                          {errors.address && (<p className="text-xs text-red-500">Alamat wajib diisi.</p>)}
                        </div>
                        ...
                        <div className="col-span-10">
                          ...
                          <input 
                            type="text" 
                            ref={register({ required: true, pattern: /^(0|[1-9][0-9]*)$/ })} 
                            name="phoneNumber" 
                            className={
                              `mt-1 block w-full shadow-sm sm:text-sm 
                              ${errors.phoneNumber 
